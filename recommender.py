...
class Recommender():
    ...
    And uses either FunkSVD or a Knowledge Based recommendation (highest ranked) to make recommendations for users.
    Finally, if given a movie, the recommender will provide movies that are most similar as a Content Based Recommender.
    """
    def __init__(self):
        """
        Initial in fit func.
            ...
            for i in range(self.n_users):
                for j in range(self.n_movies):
                    ...
                    if self.user_item_mat[i, j] > 0:
                        ...
                        # 点积 compute the error as the actual minus the dot product of the user and movie latent features
